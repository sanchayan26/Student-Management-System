                    ...
                    <div class=" p-6 bg-white border-b border-gray-200" style="font-size: 15px; color:blues;">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th>Contribution of GPA</th>
                                <th> Semester</th>
                                <th> Edit</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach ($subjects as $community)
                            <tr data-id="{{$community->id}}">
                                <td><span class="clearfix">{{$community->SubjectCode}}</span> </td>
                                <td><span class="clearfix">{{$community->SubjectName}}</span> </td>
                                <td><span class="clearfix">{{$community->Category}}</span> </td>
                                <td><span class="clearfix">{{$community->NumberOfCredits}} credits</span> </td>
                                <td><span class="clearfix">{{$community->ContributionOfGPA}}</span> </td>
                                <td><span class="clearfix">Semester: {{$community->SemesterNumber}}</span> </td>
                                <td>
                                    <a class="dropdown-item" href="{{ URL('/admin/subject/edit/'.$community->id )}}"  >Edit</a>
