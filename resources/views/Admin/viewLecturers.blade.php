                ...
                <div class="">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr data-id="{{$lecturer->id}}">
                            ...
                            <td><span class="clearfix">{{$lecturer->email}}</span> </td>
                            <td><span class="clearfix">{{$lecturer->DepartmentName}}</span> </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{ URL('/admin/enroll/'.$lecturer->LectID )}}" >EnrollSubject</a>
                                        <a class="dropdown-item" href="{{ URL('admin/lecturer/edit/'.$lecturer->LectID )}}"  >Edit</a>
                                        <a class="dropdown-item"  onclick="return confirm('Are you sure?')" href="{{ URL('admin/lecturer/delete/'.$lecturer->LectID )}}"  >Delete Lecturer</a>
