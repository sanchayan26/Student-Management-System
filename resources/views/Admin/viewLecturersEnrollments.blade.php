...
<!--                    <img src="{{url('/images/usjp.png')}}" alt="Image" style="height: 50px; position: absolute; left: 25px;"/>-->
                    <a class="nav-brand" style="position: absolute; left: 250px; font-size: 20px; color: #50c878;" href="/admin/yly_viewLectures">View Lecturers</a>
                    <a class="nav-brand" style="position: absolute; left: 30px; font-size: 20px; color: #50c878;" href="/">Main Menu</a>
                    <a class="nav-brand" style="position: absolute; left: 170px; font-size: 20px; color: #50c878;" href="/admin">Home</a>
                ...
                <div class="">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr data-id="{{$lecturer->id}}">
                            <td><span class="clearfix">{{$lecturer->LectID}}</span> </td>
                            <td><span class="clearfix">{{$lecturer->Name}}</span> </td>
                            <td><span class="clearfix">{{$lecturer->NIC_Number}}</span> </td>
                            <td><span class="clearfix">{{$lecturer->SubjectCode}}</span> </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                       <a class="dropdown-item" href="{{URL('admin/lecturer/deleteEnrollment/'.$lecturer->id)}}" >Delete Enrollment</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
