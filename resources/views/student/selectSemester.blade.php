    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="/student">Student Home <span class="sr-only">(current)</span></a>
            </li>
    ...
    <div class="row" style="color: #50c878; ">
        <div class="col-md-8 mx-auto">
            <div class="contact-form" style="margin-top: 0px;">
                <h1 style="color: black;"> View GPA</h1>
                @if(session()->has('message'))
                <div class="alert alert-success">
                    {{ session()->get('message') }}
                </div>
                @endif
                <form action="/student/viewGPA" method="post">
                    @csrf

                    <div class="row">

                        <div class="col-md-6" style="position: center; left: 200px;">
                            <label for="cars">Select Semester</label>
                            <select id="semester" name="semester" class="form-control">
                                <option value=""> Select Semester</option>
                                @foreach ($semesters as $subject)
