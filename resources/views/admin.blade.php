                    ...
                    <div class=" p-6 bg-white border-b border-gray-200" style="font-size: 20px; color: #50c878;">
                        ...
                        <section id="region-main">
                            <div class="box coursebox">
                                <a href="/admin/yly_createStudent"> Register Students</a>
                            </div>
                            <div class="box coursebox">
                                <a href="/admin/yly_viewStudent">View Students</a>
                            </div>
                            <div class="box coursebox">
                                <a href="/admin/yly_createSubjects">Register Subjects</a>
                            </div>
                            <div class="box coursebox">
                                <a href="/admin/yly_viewSubjects">View Subjects</a>
                            </div>
                            <div class="box coursebox">
                                <a href="/admin/yly_createLecturer">Register Lectures</a>
                            </div>
                            <div class="box coursebox">
                                <a href="/admin/yly_viewLectures">View Lectures</a>
                            </div>
                            <div class="box coursebox">
                                <a href="/admin/viewLecturesEnrollments">View Lecturers Enrollments</a>
                            </div>
                            <div class="box coursebox">
                                <a href="/sendStudentDetails">Send Student  user credentials</a>
                            </div>
                            <div class="box coursebox">
                                <a href="/SendLecturerCredentials">Send Lecturer  user credentials</a>
                            </div>
                            <div class="box coursebox">
                                <a href="/email"> send mail for user</a>
                            </div>
