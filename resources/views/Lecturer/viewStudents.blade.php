...
<div class="min-h-screen bg-gray-100">
    ...
    <header class="bg-white shadow">
        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8" style="color: ">
            Enrolled Students With Subjects
                ...
                <div class="">
                    ...
                    <div class=" p-6 bg-white border-b border-gray-200" style="font-size: 15px; color:blues;">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php
                            $enrollStudents=App\Models\EnrollStudent::select('*')->where('SubjectCode',$subject->SubjectCode)->get();
                            ?>
                            @foreach ($enrollStudents as $student)

                            <?php

                            $studentDetails=App\Models\Student::select('*')->where('RegistrationNumber',$student->RegistrationNumber)->get();

                            ?>

                            <tr data-id="">
                                <td><span class="clearfix">{{$studentDetails[0]->FirstName}}</span> </td>
                                <td><span class="clearfix">{{$studentDetails[0]->RegistrationNumber}}</span> </td>
